...
public:
	...
	inline v8::Local<v8::FunctionTemplate> class_function_template()
	{
		return to_local(isolate_, func_);
	}

	inline v8::Local<v8::FunctionTemplate> js_function_template()
	{
		return to_local(isolate_, js_func_);
	}

	inline void set_auto_wrap_objects(bool auto_wrap) { auto_wrap_objects_ = auto_wrap; }
	inline bool auto_wrap_objects() const { return auto_wrap_objects_; }

	inline void set_ctor(ctor_function&& ctor) { ctor_ = std::move(ctor); }
...
private:
	...
	struct base_class_info
	{
		...
		inline base_class_info(object_registry& info, cast_function cast)
			: info(info)
			, cast(cast)
		{
		}
...
private:
	...
	inline static object_pointer_type object_create(v8::Isolate* isolate, Args&&... args)
	{
	...
	{
		inline static object_pointer_type call(v8::FunctionCallbackInfo<v8::Value> const& args)
		{
	...
	inline static void object_destroy(v8::Isolate* isolate, pointer_type const& ptr)
	{
	...
	inline explicit class_(v8::Isolate* isolate, detail::type_info const& existing)
		: class_info_(detail::classes::find<Traits>(isolate, existing))
	{
	}

public:
	inline explicit class_(v8::Isolate* isolate, dtor_function destroy = &object_destroy)
	...
	inline static class_ extend(v8::Isolate* isolate)
	{
	...
	inline class_& ctor(ctor_function create = &Create::call)
	{
	...
	inline class_& auto_wrap_objects(bool auto_wrap = true)
	{
	...
	inline class_& function(std::string_view name, Function&& func, v8::PropertyAttribute attr = v8::None)
	{
		constexpr bool is_mem_fun = std::is_member_function_pointer_v<Function>;

		static_assert(std::is_member_function_pointer<Function>::value || detail::is_callable<Function>::value,
	...
	inline class_& var(std::string_view name, Attribute attribute)
	{
	...
	inline class_& property(std::string_view name, GetFunction&& get, SetFunction&& set = {})
	{
	...
	inline class_& const_(std::string_view name, Value const& value)
	{
		v8::HandleScope scope(isolate());
	...
	template<typename Value>
	inline class_& static_(std::string_view const& name, Value const& value, bool readonly = false)
	{
		v8::HandleScope scope(isolate());
	...
	inline static v8::Local<v8::Object> reference_external(v8::Isolate* isolate,
	...
	inline static void unreference_external(v8::Isolate* isolate, object_pointer_type const& ext)
	{
		using namespace detail;
	...
	/// to allocate `ext`
	inline static v8::Local<v8::Object> import_external(v8::Isolate* isolate, object_pointer_type const& ext)
	{
		using namespace detail;
	...
	inline static object_pointer_type unwrap_object(v8::Isolate* isolate, v8::Local<v8::Value> value)
	{
		using namespace detail;
	...
	template<typename... Args>
	inline static v8::Local<v8::Object> create_object(v8::Isolate* isolate, Args&&... args)
	{
	...
	inline static v8::Local<v8::Object> find_object(v8::Isolate* isolate,
	...
	inline static v8::Local<v8::Object> find_object(v8::Isolate* isolate, T const& obj)
	{
		using namespace detail;
	...
	inline static void destroy_object(v8::Isolate* isolate, object_pointer_type const& obj)
	{
		using namespace detail;
	...
	inline static void destroy_objects(v8::Isolate* isolate)
	{
		using namespace detail;
	...
	inline static void destroy(v8::Isolate* isolate)
	{
		using namespace detail;
...
private:
	template<typename Attribute>
	inline static void member_get(v8::Local<v8::Name>,
	...
	template<typename Attribute>
	inline static void member_set(v8::Local<v8::Name>, v8::Local<v8::Value> value,
